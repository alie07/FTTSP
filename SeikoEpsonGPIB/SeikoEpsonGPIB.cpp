...
//SeikoEpson 1.4 : 29/03/2013 (pgy)
//				- Suppress the check on the Bin = 0, as it seems that the test is done on the Setup file 
//				  definition and not on the on the real handler setup !!!
